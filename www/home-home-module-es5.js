    ...
    function zpKS(module, __webpack_exports__, __webpack_require__) {
      ...
      var HomePage = /*#__PURE__*/function () {
        ...
        _createClass(HomePage, [{
          key: "getTime",
          value: function getTime(ev) {
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
              var _this = this;

              var val, latLng, response, lt, lng, proxyURL, rests, httpString;
                ...
                while (1) {
                  switch (_context.prev = _context.next) {
                    case 0:
                      val = ev.target.value;
                      val = val.trim();
                      val = val.replace(/\s/g, '+'); //var latLng = await this.getLatLng(val);
                    ...
                    case 5:
                      ...
                      latLng = response; //console.log("ltlng: " + latLng);

                      lt = latLng[0];
                      lng = latLng[1];
                      console.log("lt: " + lt + " lng: " + lng);
                      proxyURL = "https://cors-anywhere.herokuapp.com/";
                      rests = "https://maps.googleapis.com/maps/api/place/nearbysearch/json?query=restaurant&location=" + lt + "," + lng + "&radius=15000&&type=restaurant&key=AIzaSyDN6CczC9Jy5lKDlw8ET2Z_cpjbLjTf5k8";
                      httpString = proxyURL.concat(rests);
                      this.http.get(httpString).subscribe(function (response) {
                        console.log(response);

                        for (var i = 0; i < 20; i++) {
                          if (response['results'][i].hasOwnProperty("opening_hours")) {
                            _this.locations[response['results'][i]['place_id']] = [response['results'][i]['name'], response['results'][i]['vicinity'], response['results'][i]['photos'][0]['photo_reference'], [0, response['results'][i]['opening_hours']['open_now']]];
                          } else {
                            _this.locations[response['results'][i]['place_id']] = [response['results'][i]['name'], response['results'][i]['vicinity'], response['results'][i]['photos'][0]['photo_reference'], [1]];
                          }

                          _this.selected[response['results'][i]['place_id']] = 0;
                        }

                        console.log(_this.locations[response['results'][2]['place_id']]);
                        console.log(_this.selected[response['results'][2]['place_id']]);
                      });
          ...
          key: "getLatLng",
          value: function getLatLng(city) {
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
              var placesString, ltLng, response;
              return regeneratorRuntime.wrap(function _callee2$(_context2) {
                while (1) {
                  switch (_context2.prev = _context2.next) {
                    case 0:
                      placesString = 'https://maps.googleapis.com/maps/api/geocode/json?address=' + city + '&key=AIzaSyDN6CczC9Jy5lKDlw8ET2Z_cpjbLjTf5k8';
                      _context2.next = 3;
                      return this.http.get(placesString, {
                        responseType: 'json'
                      }).toPromise();
                    ...
                    case 3:
                      ...
                      return _context2.abrupt("return", ltLng);
